...
This app will focus on the latter.  
...
The Data Structure and Algorithms porition of your interview will be on the few data sets covered below. And interviews will only ask you questions based upon 2 concepts: iterating and searching. You WILL NOT be asked questions on sorting. Nobody at any level is expecting you to whip out a Merge Sort of Quick Sort or solve the Traveling Salesman during an interview. So do not stress over this at all. All you need to know well is 2 concepts: how to iterate and search over various data structures. That's it. All questions you are asked will just be a varation over this base concept. So here's the answers ahead of time. Just modify them to suit your interviewer's needs. 
